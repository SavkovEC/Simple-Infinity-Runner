...
public abstract class TweenerInspector : Editor {
	...
	override public void OnInspectorGUI() {
		...
		EditorGUILayout.EndHorizontal();
		if (CurvesForTweener.InstanceIfExist != null) {
			List<string> curves = CurvesForTweener.Instance.IdList;
		...
		if (CurvesForTweener.InstanceIfExist != null) 
        {
            ...
            {
				CurvesForTweener.Instance.AddCurve(tween.AnimationCurveId, tween.animationCurve);
			}
