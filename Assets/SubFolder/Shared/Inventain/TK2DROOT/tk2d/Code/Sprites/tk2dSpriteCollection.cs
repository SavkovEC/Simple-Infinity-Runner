...
public class tk2dSpriteCollectionDefinition
{
    ...
    public bool disableInnerPadding = false;
...
public class tk2dSpriteCollection : MonoBehaviour 
{
	...
	public bool usePosterize = false;
	public int posterizeValue = 256;
    ...
    public string[] atlasTexturePaths = new string[0];
