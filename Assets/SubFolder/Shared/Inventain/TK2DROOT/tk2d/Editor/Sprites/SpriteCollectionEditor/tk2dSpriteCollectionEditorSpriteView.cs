...
namespace tk2dEditor.SpriteCollectionEditor
{
	public class SpriteView
	{
		...
		public void DrawSpriteEditorInspector(List<SpriteCollectionEditorEntry> entries, bool allowDelete, bool editingSpriteSheet)
		{
            ...
            param.disableInnerPadding = EditorGUILayout.Toggle("Disable Inner Padding", param.disableInnerPadding);
            HandleMultiSelection(entries, (a,b) => a.disableInnerPadding == b.disableInnerPadding, (a,b) => b.disableInnerPadding = a.disableInnerPadding);
