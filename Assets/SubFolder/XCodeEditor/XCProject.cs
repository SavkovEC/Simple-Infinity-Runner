...
//				PBXGroup librariesGroup = this.GetGroup( "Libraries" );
			...
			Debug.Log( "Adding librarysearchpaths..." );
			...
			Debug.Log( "Adding frameworksearchpath..." );
			...
			Debug.Log( "Adding plist..." );
			if (mod.plist != null)
			{
				foreach (string plistMod in mod.plist) 
				{
					UnityEditor.XCodeEditor.XCInfoPlist.UpdatePlist(projectRootPath, plistMod);
				}
			}
		}
